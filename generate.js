...
module.exports = {
	...
	description: 'Generate A Code.', // Command description
                ...
                fs.readFile(filePath, function (error, data) {
                    ...
                    if (!error) {
                        ...
                        message.author.send(
                            ...
                            .setTitle('')
                            .addField('**Generated**', `\`\`\`${args[0][0].toUpperCase()}${args[0].slice(1).toLowerCase()}\`\`\``, true)
                            .addField('**Special Code**', `\`\`\`${firstLine}\`\`\``, true)
                        .setImage('https://media.discordapp.net/attachments/1193533928552812545/1193608580016902254/stremur-mouse-remote2x.png?ex=65ad559d&is=659ae09d&hm=8feacb40ccbc672e1699c5f9b86cf44a4aaaa66fa79227d758dea65a638d5da6&')                                            .setDescription('### Insert The Special Code In This Website [ [Click Here](https://sites.google.com/view/discord-stremio/page) ]')
                        )
                        ...
                        if (position !== -1) {
                            ...
                            fs.writeFile(filePath, data, function (error) {
                                message.channel.send(
                                    ...
                                    .setColor(config.color.green)
                                    .setTitle('')
                                    .setDescription(`# Check Your Messages ${message.author}`)

.setImage("https://media.discordapp.net/attachments/1193533928552812545/1193608580016902254/stremur-mouse-remote2x.png?ex=65ad559d&is=659ae09d&hm=8feacb40ccbc672e1699c5f9b86cf44a4aaaa66fa79227d758dea65a638d5da6&")
